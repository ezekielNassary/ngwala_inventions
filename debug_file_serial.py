...
class App:
            ...
            if len(rpsl) >= 4:
                if rpsl[2] == "0":
                    ...
                    try:
                        ...
                        vl = vl * 100
                        print("Strength  : " + str("{:.2f}".format(vl)) + "%")
                    except:
                        pass
                    self.wdt.feed()
                    self.tsp(3)
                ...
                if x in custkeys:
                    ...
                    if x == "#":
                        if self.amount_entered == "0000":
                            ...
                            print("Kiasi siyo sahihi weka kuanzia  " +
    ...
    def mpangilio(self):
        ...
        number = ""
        data = self.r_d()
        print("Tank Level:%.2f L " % (data['level']))
        print("Enter Level...")
        i = 6
        loop = True
        while loop:
                    ...
                    if found:
                        ...
                        if (self.balance - 0.2) > 0:
                            ...
                            if lvl > 1:
                                ...
                                print("No enough paste in tank")
                        else:
                            print("Kadi  " +
                                  str(crd)[:4] + "*****", "Haina Salio")
